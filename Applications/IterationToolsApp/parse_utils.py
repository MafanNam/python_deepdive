...
def group_data(names, class_names, parsers, compress_fields, filter_key, *, group_key, gender):
    data = filtered_iter_combined(names, class_names, parsers, compress_fields, key=filter_key)
