...
ax1.plot(t, signal1, color="blue", linewidth=1)
ax1.grid(True)
ax1.set_title('Cигнал КП6')
ax1.set_facecolor('#DCEDC8')

ax2.plot(d, signal1, color="navy", linewidth=1)
ax2.grid(True)
ax2.set_title('Фазовый портет dz/dt')
ax2.set_facecolor('#DCEDC8')

ax3.plot(y, signal1, color="mediumblue", linewidth=1)
ax3.grid(True)
ax3.set_title('Фазовый портер с задержкой')
ax3.set_facecolor('#DCEDC8')
fig.set_facecolor('#B0E0F0')
