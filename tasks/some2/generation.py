...
class GenerationGUI(QtWidgets.QMainWindow):
    def __init__(self, parent):
        ...
        # self.horizont.addItem(QtWidgets.QSpacerItem(200, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum))
    ...
    def __add_h_slider(self):
        ...
        self.h_slider.setValue(self.ekg_simulator.h * 100)
    ...
    def __plot_ekg(self):
        ...
        self.graphWidget.plot(x, y, clear=True, pen=pg.mkPen(color=('#139A1C'), width=1.5))
